...
public class HttpClient {
    ...
    public static String getRequest(String url)
        ...
        try {
            ...
            in = new BufferedReader(
                    new InputStreamReader(httpConn.getInputStream(), CHARACTER_ENCODING));
            while ((inputLine = in.readLine()) != null) {
                sBuffer.append(inputLine);
            }
            in.close();
    ...
    public static void main(String[] args) throws Exception {
      ...
      // HttpClient.postRequest("http://localhost:8080/tasting_server/api/user/info/detail", "111");
        String b=URLEncoder.encode("【大话主播】验证码123456","UTF-8");
        System.out.println(HttpClient.postRequest("http://101.201.54.221:8888/sms.aspx?action=send&userid=155&account=lanmifeng&password=lanmifeng321/*-&mobile=13811155196&content="+b+"&sendTime=&extno=", ""));
