...
<link rel="stylesheet" href="<%=request.getContextPath() %>/media/css/DT_bootstrap.css" />
<link rel="stylesheet" href="<%=request.getContextPath() %>/media/dataTables.bootstrap.css" />
<link rel="stylesheet" href="<%=request.getContextPath() %>/media/dataTables.responsive.css" />
<!-- BEGIN PAGE LEVEL STYLES -->
<link href="<%=request.getContextPath() %>/media/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" />
...
<link href="<%=request.getContextPath() %>/media/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath() %>/media/css/jquery.fancybox.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath() %>/media/css/jquery.fileupload-ui.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath() %>/media/css/bootstrap-fileupload.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath() %>/media/css/fileinput.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath() %>/media/css/profile.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath() %>/media/css/glyphicons.css" rel="stylesheet" type="text/css" />
<link href="<%=request.getContextPath() %>/media/css/bootstrap-modal.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/media/css/pricing-tables.css" />
<!-- END PAGE LEVEL STYLES -->
<link rel="shortcut icon" href="<%=request.getContextPath() %>/media/image/favicon.ico" />
<link rel="stylesheet" href="<%=request.getContextPath() %>/media/style.min.css" />
