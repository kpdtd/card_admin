        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        <li><i class="icon-list"></i><a href="javascript:;">用户账户信息</a><i class="icon-angle-right"></i>
                        </li>
...
<script>
    jQuery(document).ready(function () {
        ...
        $('.btn.green').click(function () {
            App.Modal.load('./add', {}, {'title': '添加账户信息'});
        });

    });

    function detailPage(id){
        App.Modal.load("./detailPage",{'id' : id},{"title":"用户账户详情"});
    }
    function initPage() {
        var oTable = $('#portlet_Tables').dataTable({
            ...
            "aoColumns": [{
                ...
                "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                    ...
                    <%--  </shiro:hasPermission>  --%>
                    html += '<a href="javascript:;" onclick="detailPage('+oData.userId+')">详情</a>';
