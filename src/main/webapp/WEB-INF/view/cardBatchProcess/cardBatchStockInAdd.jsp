		...
		<form id="form_sample_1" action="#" class="form-horizontal dialog" enctype="multipart/form-data"
			...
			<div class="control-group">
				<label class="control-label" for="firstName">
					<span class="required">*</span>选择运营商
				</label>
				<div class="controls">
					<select id="supplierId" class="m-wrap medium select2" name="supplierId">
						<!-- <option value=""></option> -->
			...
			<div class="control-group">
				<label class="control-label" for="firstName" style="white-space: nowrap">
					<span class="required">*</span>选择卡归属方
				</label>
				<div class="controls">
					<select id="cardOwnerId" class="m-wrap medium select2" name="cardOwnerId">
						<!-- <option value=""></option> -->
			...
			<div class="control-group">
				<label class="control-label" for="firstName">
					<span class="required">*</span> 卡生命周期
				</label>
				<div class="controls">
					<select id=cardState class="m-wrap medium select2" name="cardState">
						<!-- <option value=""></option> -->
