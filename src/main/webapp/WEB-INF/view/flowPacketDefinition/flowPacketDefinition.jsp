			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							<li><i class="icon-list"></i><a href="javascript:;">流量包定义</a><i class="icon-angle-right"></i></li>
	...
	<script>
		jQuery(document).ready(function() {
			...
			$('.btn.green').click(function(){
				App.Modal.load('./add',{},{'title':'添加流量包'});
			});

		});
		
		function edit(id){
			App.Modal.load("./add",{'id' : id},{"title":"修改流量包"});
		}
		function initPage() {
